                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <div style="margin-top : 7px;">
                                        ...
                                        <input type="checkbox" value="true" id="depotlegal" name="depotlegal" <?php if (Yii::app()->session['search']->depotlegal) echo "checked"; ?>> Inclure les périodiques du dépot légal BCU
